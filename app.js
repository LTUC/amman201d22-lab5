...
function multiply(a, b) {
  let n = a * b;
  return [n, 'The product of ' + a + ' and ' + b + ' is ' + n + '.'];
}
...
function sumArray(sumArr) {
 let r=sum(sum(testArray[0],testArray[1])[0],testArray[2])[0];
  
  return[r, testArray[0] +',' + testArray[1]+ ',' + testArray[2] + ' was passed in as an array of numbers, and ' + r + ' is their sum.'];
}
...
function multiplyArray(multArr) {
  let multotal = 1;
  for (let l=0; l < multArr.length; ++l){
    multotal =(multiply(multotal,multArr[l])[0]);
   }
    return [multotal, 'The numbers ' + multArr + ' have a product of ' + multotal + '.'];
