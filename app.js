...
function sumArray(sumArr) {
  let arrySum=sumAndMultiply(sumArr[0],sumArr[1],sumArr[2])[0];
  console.log(arrySum);
...
function multiplyArray(multArr) {
  let arryMulti=sumAndMultiply(multArr[0],multArr[1],multArr[2])[1];

  return[arryMulti,`The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${arryMulti}.`]
}
