...
function multiply(a, b,c) {
  let cal=a*b;
  return [cal, `The product of ${a} and ${b} is ${cal}.`]
  //eslint-disable-line
}
...
function sumArray(sumArr) {
  let summation = sumAndMultiply(testArray[0],testArray[1],testArray[2])[0];
...
function multiplyArray(multArr) {
  //eslint-disable-line
  let multiplication=sumAndMultiply(testArray[0],testArray[1],testArray[2])[1]
